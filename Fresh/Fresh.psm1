...
function DisableSMB {
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Lsa" -Name "DisableStrictNameChecking" -Type "DWORD" -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Lsa" -Name "DisableLoopbackCheck" -Type "DWORD" -Value 1 -Force
...
function DisableDefenderCloud {
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet" -Name "DisableBlockAtFirstSeen" -Type DWord -Value 1 -Force
}
...
function BestPriorityForeground {
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" -Name InterfaceMetric -PropertyType DWord -Value 70 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" -Name TCPMaxDataRetransmissions -PropertyType DWord -Value 7 -Force
    ...
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" -Name EnablePMTUBHDiscovery -PropertyType DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" -Name EnableConnectionRateLimiting -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" -Name DisableTaskOffload -PropertyType DWord -Value 0 -Force
    New-ItemProperty -Path "HKCU:\Control Panel\Mouse" -Name RawInput -PropertyType String -Value 1 -Force
    ...
    New-ItemProperty -Path "HKCU:\Control Panel\Mouse" -Name MouseHoverTime -PropertyType String -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Input\Settings\ControllerProcessor\CursorSpeed" -Name IRRemoteNavigationDelta -PropertyType DWord -Value 1 -Force
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" -Name RunStartupScriptSync -PropertyType DWord -Value 0 -Force
...
function DisableAutoUpdateDriver {
    ...
    if (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching")) {
        New-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Force
    }
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Name "DontPromptForWindowsUpdate" -Type DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Name "DontSearchWindowsUpdate" -Type DWord -Value 1 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Name "DriverUpdateWizardWuSearchEnabled" -Type DWord -Value 0 -Force
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" -Name "SearchOrderConfig" -Type DWord -Value 0 -Force
...
function NetworkConnectionStatusIndicator {
    ...
    New-ItemProperty -Path HKLM:\SOFTWARE\Policies\Microsoft\Windows\NetworkConnectivityStatusIndicator -Name DisablePassivePolling -PropertyType DWord -Value 1 -Force
}
...
function AdjustBestPerformance {
    ...
    New-ItemProperty -Path "HKCU:\Control Panel\Desktop" -Name UserPreferencesMask -PropertyType Binary -Value ([byte[]](90, 12, 01, 80, 10, 00, 00, 00)) -Force
    ...
    if (!(Test-Path "HKCU:\Software\Microsoft\Windows\Shell\BagMRU")) {
        New-Item -Path HKCU:\Software\Microsoft\Windows\Shell\BagMRU -Force
    }
...
function MaxConnectionsPer_0Server {
    ...
    New-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" -Name "MaxConnectionsPer1_0Server" -PropertyType DWord -Value 2 -Force
}
...
function DebloatMicrosoftServices {
    ...
    Stop-Service "discache" -Force -WarningAction SilentlyContinue
    Set-Service discache -StartupType Disabled -ErrorAction SilentlyContinue
    ...
    Stop-Service "TimeBrokerSvc" -Force -WarningAction SilentlyContinue
    Set-Service TimeBrokerSvc -StartupType Disabled -ErrorAction SilentlyContinue
    ...
    Set-Service luafv -StartupType Disabled -ErrorAction SilentlyContinue
    ...
    Stop-Service "wlidsvc" -Force -WarningAction SilentlyContinue
