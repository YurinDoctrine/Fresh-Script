...
function Chocolatey 
{
    ...
    -NoProfile -ExecutionPolicy Bypass -Command "choco install -y --allow-empty-checksums chocolatey-core.extension ffmpeg mpc-hc k-litecodecpackfull chocolatey-dotnetfx.extension 7zip.install jpegview vcredist-140 directx googlechrome transmission-qt"
}
#endregion System
