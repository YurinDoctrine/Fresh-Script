...
function DisableEdgeUpdate {
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\EdgeUpdate" -Name "Allowsxs" -Type DWord -Value 1 -Force
}
...
function AdjustBestPerformance {
    ...
    New-ItemProperty -Path "HKCU:\Control Panel\Desktop" -Name UserPreferencesMask -PropertyType Binary -Value ([byte[]](90, 12, 01, 80)) -Force
